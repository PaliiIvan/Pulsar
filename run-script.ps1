...
$streamServerMet = "$main_location\pulsar.stream-core.net\web\Web.csproj"
Write-Host "Starting..."

Start-Process PowerShell -ArgumentList "Write-Host 'Start Node Js Server'; npm run-script watch --prefix '$nodeJs'; Read-Host"
Start-Process PowerShell -ArgumentList "Write-Host 'Start Node Js Identity Server'; npm run-script watch-debug --prefix '$identityNodeJs'; Read-Host"
Start-Process PowerShell -ArgumentList "Write-Host 'Start Angular'; npm start --prefix '$angular'; Read-Host"
Start-Process PowerShell -ArgumentList "Write-Host 'Start Stream DotNet'; dotnet watch  -p '$streamServerMet' run; Read-Host"
